...
public class ParallaxImageView extends ImageView {
    ...
    private final float DEFAULT_PARALLAX_RATIO = 2.3f;
    ...
    private void calculateAndMove() {
        ...
        if (shouldCenterCrop) {
            ...
            Log.d(TAG, String.valueOf(this.getTag()) + " - " + scale);
            imageHeight *= scale;
        }

        float difference = imageHeight - rowHeight;
        float move = (distanceFromCenter / recyclerViewHeight) * difference * getParallaxRatio();
    ...
    private float getParallaxRatio() {
        TypedValue outValue = new TypedValue();
        getContext().getResources().getValue(R.dimen.parallax_speed, outValue, true);
